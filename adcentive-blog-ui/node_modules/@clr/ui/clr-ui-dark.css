...
.btn clr-icon {
  transform: translate3d(0rem, -0.083333rem, 0); }
...
.btn-sm:not(.btn-link) clr-icon, .alert-app-level .alert-item .btn:not(.btn-link) clr-icon {
  width: 0.5rem;
  height: 0.5rem;
  transform: translate3d(0rem, -0.041667rem, 0); }
...
.radio.btn.btn-inverse input[type='radio']:checked + label, .alert-app-level .alert-item .radio.btn input[type='radio']:checked + label, .radio.btn.btn-inverse input[type='radio']:checked + label, .alert-app-level .alert-item .radio.btn input[type='radio']:checked + label {
  background-color: rgba(255, 255, 255, 0.15);
  color: #fff; }
...
.card-footer .checkbox-inline.btn label,
.card-footer .radio.btn label,
.card-footer .radio-inline.btn label {
  line-height: calc(1rem - 1px); }
...
.alert-icon-wrapper {
  -ms-flex: 0 0 1.041667rem;
  flex: 0 0 1.041667rem;
  -ms-flex-item-align: start;
...
.clr-col-1, .clr-col-2, .clr-col-3, .clr-col-4, .clr-col-5, .clr-col-6, .clr-col-7, .clr-col-8, .clr-col-9, .clr-col-10, .clr-col-11, .clr-col-12, .clr-col,
.clr-col-auto, .clr-col-sm-1, .clr-col-sm-2, .clr-col-sm-3, .clr-col-sm-4, .clr-col-sm-5, .clr-col-sm-6, .clr-col-sm-7, .clr-col-sm-8, .clr-col-sm-9, .clr-col-sm-10, .clr-col-sm-11, .clr-col-sm-12, .clr-col-sm,
.clr-col-sm-auto, .clr-col-md-1, .clr-col-md-2, .clr-col-md-3, .clr-col-md-4, .clr-col-md-5, .clr-col-md-6, .clr-col-md-7, .clr-col-md-8, .clr-col-md-9, .clr-col-md-10, .clr-col-md-11, .clr-col-md-12, .clr-col-md,
.clr-col-md-auto, .clr-col-lg-1, .clr-col-lg-2, .clr-col-lg-3, .clr-col-lg-4, .clr-col-lg-5, .clr-col-lg-6, .clr-col-lg-7, .clr-col-lg-8, .clr-col-lg-9, .clr-col-lg-10, .clr-col-lg-11, .clr-col-lg-12, .clr-col-lg,
.clr-col-lg-auto, .clr-col-xl-1, .clr-col-xl-2, .clr-col-xl-3, .clr-col-xl-4, .clr-col-xl-5, .clr-col-xl-6, .clr-col-xl-7, .clr-col-xl-8, .clr-col-xl-9, .clr-col-xl-10, .clr-col-xl-11, .clr-col-xl-12, .clr-col-xl,
.clr-col-xl-auto {
  width: 100%;
  min-height: 1px;
  padding-right: 0.5rem;
    ...
    .login-wrapper .login .login-group {
      ...
      .login-wrapper .login .login-group .error {
        ...
        .login-wrapper .login .login-group .error:before {
          ...
          margin: 0.041667rem 0.25rem 0 0;
          height: 0.666667rem;
          width: 0.666667rem; }
...
.table {
  ...
  .table td {
    ...
    padding: 0.458333rem 0.5rem 0.458333rem;
    text-align: center;
    vertical-align: top; }
    .table th.left,
    .table td.left {
...
.table-compact th,
.table-compact td {
  padding-top: calc(0.208334rem + 1px);
  padding-bottom: calc(0.208334rem); }
...
.table.table-noborder {
  ...
  .table.table-noborder td {
    border-top: 0 none;
    padding-top: calc(0.458333rem + 1px); }
...
.table.table-compact.table-noborder td {
  padding-top: calc(0.208334rem + 2px);
  padding-bottom: calc(0.208334rem + 1px); }
...
.clr-checkbox-wrapper {
  ...
  .clr-checkbox-wrapper input[type='checkbox'] + label::after {
    ...
    height: 0.208333rem;
    width: 0.333334rem;
    border-left: 0.083333rem solid #fff;
    border-bottom: 0.083333rem solid #fff;
    top: 0.166666rem;
    left: 0.166667rem;
    transform: translate(0, 0.166667rem) rotate(-45deg);
    border-color: #000; }
  ...
  .clr-checkbox-wrapper input[type='checkbox'].clr-indeterminate + label::after {
    ...
    display: inline-block;
    transform: translate(0, 0.166667rem); }
...
.clr-form-control-disabled .clr-checkbox-wrapper input[type='checkbox']:checked + label::after {
  border-left: 0.083333rem solid #000;
  border-bottom: 0.083333rem solid #000; }
...
.checkbox-inline {
  ...
  .checkbox-inline input[type='checkbox'] + label::after {
    ...
    height: 0.208333rem;
    width: 0.333334rem;
    border-left: 0.083333rem solid white;
    border-bottom: 0.083333rem solid white;
    top: 0.166666rem;
    left: 0.166667rem;
    transform: translate(0, 0.166667rem) rotate(-45deg);
    border-color: #000; }
  ...
  .checkbox-inline.disabled input[type='checkbox']:checked + label::after {
    border-left: 0.083333rem solid #22343c;
    border-bottom: 0.083333rem solid #22343c; }
...
.clr-option {
  ...
  width: 100%;
  text-transform: none; }
  .clr-option:hover, .clr-option:focus {
    background-color: #29414e;
    color: #adbbc4;
    text-decoration: none; }
  .clr-option.active {
  ...
  .clr-option.disabled, .clr-option:disabled {
    ...
    .clr-option.disabled:hover, .clr-option:disabled:hover {
      background: none; }
    .clr-option.disabled:active, .clr-option.disabled:focus, .clr-option:disabled:active, .clr-option:disabled:focus {
      background: none;
      box-shadow: none; }
...
.stack-view {
  ...
  .stack-view .stack-block-label {
    ...
    .stack-view .stack-block-label::before {
      ...
      height: 0.416667rem;
      width: 0.416667rem;
      margin: 0.291667rem 0.25rem 0 0;
      text-align: center; }
...
.datagrid-compact .datagrid-column, .datagrid-compact .datagrid .datagrid-head .datagrid-row-actions, .datagrid .datagrid-head .datagrid-compact .datagrid-row-actions,
...
.datagrid-overlay-wrapper {
  ...
  .datagrid-overlay-wrapper .datagrid-spinner {
    ...
    .datagrid-overlay-wrapper .datagrid-spinner .spinner {
      word-wrap: normal; }
...
.datagrid-no-layout {
  ...
  .datagrid-no-layout .datagrid .datagrid-head .datagrid-row-actions,
  .datagrid .datagrid-head .datagrid-no-layout .datagrid-row-actions {
    display: block; }
...
.datagrid {
  ...
  .datagrid .datagrid-cell {
    ...
    .datagrid .datagrid-cell.datagrid-fixed-column {
      -ms-flex: 0 0 1.583333rem;
      flex: 0 0 1.583333rem;
      max-width: 1.583333rem;
      min-width: 1.583333rem; }
  ...
  .datagrid .datagrid-foot-select.checkbox {
    display: block;
    line-height: inherit;
    -ms-flex: 0 0 1.416667rem;
    flex: 0 0 1.416667rem;
    margin-right: 0.083333rem; }
  ...
  .datagrid .datagrid-expandable-caret {
    padding: calc(0.125rem - 1px) 0.166667rem 0.125rem;
    text-align: center; }
  ...
  .datagrid .datagrid-body .datagrid-row {
    ...
    .datagrid .datagrid-body .datagrid-row .datagrid-action-overflow {
      ...
      .datagrid .datagrid-body .datagrid-row .datagrid-action-overflow::after {
        ...
        height: 0;
        margin-top: -0.208333rem;
        border-right: 0.208333rem solid #22343c;
        border-top: 0.208333rem solid transparent;
        border-bottom: 0.208333rem solid transparent; }
    ...
    .datagrid .datagrid-body .datagrid-row .datagrid-action-toggle {
      ...
      margin: calc(0.125rem - 1px) 0.166667rem; }
...
.datagrid-compact .datagrid-foot {
  ...
  .datagrid-compact .datagrid-foot .column-switch-wrapper .column-toggle--action {
    margin: 0;
    outline-offset: -0.166667rem; }
  .datagrid-compact .datagrid-foot .datagrid-foot-select input[type='checkbox'] + label::before, .datagrid-compact .datagrid-foot .datagrid-foot-select input[type='checkbox'] + label::after {
    top: 0.11111rem; }
...
.clr-wizard .modal-dialog {
  ...
  -ms-flex-align: center;
  align-items: center;
  box-shadow: 0 0.041667rem 0.083333rem 0.083333rem rgba(0, 0, 0, 0.2);
  height: 50%;
  max-height: 100%; }
...
.clr-wizard--inline {
  ...
  .clr-wizard--inline.clr-wizard .modal-content {
    ...
    height: auto;
    max-height: 100%; }
    .clr-wizard--inline .clr-wizard-stepnav-wrapper .clr-wizard-stepnav,
    .clr-wizard--inline.clr-wizard .modal-content .clr-wizard-stepnav {
      height: 100%; }
